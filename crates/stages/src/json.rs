...
pub(crate) fn read_json(file_path: &Path) -> Result<Value> {
...
pub(crate) fn write_json(file_path: &Path, json_value: &Value) -> Result<()> {
...
pub(crate) fn set_json_property<P: Into<Value>>(json_value: &mut Value, key: &str, value: P) {
